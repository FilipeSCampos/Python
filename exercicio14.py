...
peso = int(input('quantos quilos você pescou hoje?: '))
multa = (peso - 50) * 4
if peso > 50:
    print('o peso em excesso foi de:', (peso - 50))
elif peso <= 50:
    print('hoje deu bom João Papo-de-Pescador')
else:
    print()    

if multa > 0:
    print(f'E a multa foi de:, {multa}')
else:
    ()